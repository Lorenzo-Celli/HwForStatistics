...
{
    public string[][] TsvToMatrix(string filePath)
    {
    ...
    public void QuantitativeDiscreteFreq(string[][] dataSet)
    {
        //absolute frequency
    ...
    public void QuantitativeContinuousFreq(string[][] dataSet)
    {
        //absolute frequency
    ...
    public Dictionary<string, int> CountOccurrencesInIntervals(SortedSet<int> set, int numberOfIntervals)
    {
        if (set.Count == 0)
    ...
    public void QualitativeFreq(string[][] dataSet)
    {
